...
class MainActivity : AppCompatActivity()
{
    ...
    lateinit var intBinaryOperation : IBinaryOperator<Int>

    @Inject
    @IntMultiplyOperationInterceptor
    lateinit var intBinaryOperationMultiply : IBinaryOperator<Int>
    ...
    fun handleCalculateButton()
    {
        ...
        else if (intBinaryOperationMultiply.isValid(mBinding.operationInfo!!.op))
            mBinding.result = intBinaryOperationMultiply.applyAsInt(mBinding.operationInfo!!.first,
                mBinding.operationInfo!!.second).toString()
